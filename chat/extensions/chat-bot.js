...
import { addRxPlugin, createRxDatabase, lastOfArray, deepEqual } from "esm.sh:rxdb@15.0.0-beta.13";
import { RxDBDevModePlugin } from "esm.sh:rxdb@15.0.0-beta.13/plugins/dev-mode";
import { replicateRxCollection } from "esm.sh:rxdb@15.0.0-beta.13/plugins/replication";
import { getRxStorageMemory } from "esm.sh:rxdb@15.0.0-beta.13/plugins/storage-memory";
